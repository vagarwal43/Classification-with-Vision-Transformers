...
sys.path.append("/home/dell/transformers/transformer_captioning") 
...
class ViT(nn.Module):
    ...
    def __init__(self, patch_dim, d_model, d_ff, num_heads, num_layers, num_patches, num_classes, device = 'cuda'):
        ...
        self.positional_encoding = PositionalEncoding(d_model, max_len = num_patches, dropout = 0.1)
    ...
    def patchify(self, images):
        ...
        patches = patches.view(N, num_patches, -1)
    ...
    def forward(self, images):
        ...
        output = torch.cat([self.cls_token.repeat(patches_embedded.size(0), 1, 1), patches_embedded], dim=1)
